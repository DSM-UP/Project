...
class AfterSchoolExchange extends PureComponent {
  ...
  onClick = () => {
    ...
    Axios.patch('http://13.209.68.218/activity-each', { date1, date2 }, { headers: { accessToken } })
    .then(res => {
  ...
  render() {
    ...
    return (
      <>
        ...
        <input onClick={this.onClick} type="button" value="교체" id="schedule-change-mode" className="manage-modify-button showSecondBox" />
      </>
    )
  }
}
