...
class ManagerExchange extends PureComponent {
  ...
  onClick = () => {
    ...
    Axios.patch(
      "http://3.34.125.239/teacher-each",
      { date1: _date1, date2: _date2, selected1, selected2, floor1, floor2 },
      { headers: { accessToken } }
    )
      .then((res) => {
    ...
    return (
      <>
        <TeacherSelect
          version={2}
          date={date1}
          setDate={this.setDate1}
          setSelected={this.setSelected1}
          selected={selected1}
        />
        <TeacherSelect
          version={3}
          date={date2}
          setDate={this.setDate2}
        ...
        <input
          ...
          className="manage-modify-button modify-button-mode"
        />
      </>
    );
  }
